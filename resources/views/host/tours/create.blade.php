<x-dashboard-layout>
    <x-slot name="header">
        <div class="flex items-center">
            ...
            <h2 class="text-xl font-semibold text-gray-800">Tạo Tour Mới</h2>
        </div>
    </x-slot>

    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden max-w-4xl mx-auto">
        <form action="{{ route('host.tours.store') }}" method="POST" enctype="multipart/form-data" class="p-6 md:p-8">
            @csrf
            ...
            <div class="mb-8 border-b border-gray-200 pb-8">
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div class="col-span-1">
                        ...
                        <input type="text" name="location" id="location" value="{{ old('location') }}" placeholder="VD: Hà Giang, Sapa..." class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm" required>
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea name="description" id="description" rows="4" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm" required>{{ old('description') }}</textarea>
                    ...
                    <div>
                        ...
                        <div class="relative mt-1 rounded-md shadow-sm">
                            <input type="number" name="price" id="price" value="{{ old('price') }}" min="0" step="1000" class="block w-full rounded-md border-gray-300 pl-4 pr-12 focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm" required>
                    ...
                    <div>
                        ...
                        <input type="number" name="duration_days" id="duration_days" value="{{ old('duration_days', 1) }}" min="1" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm" required>
                    ...
                    <div>
                        ...
                        <input type="number" name="duration_nights" id="duration_nights" value="{{ old('duration_nights', 0) }}" min="0" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm" required>
                    ...
                    <div>
                        ...
                        <input type="number" name="capacity" id="capacity" value="{{ old('capacity', 1) }}" min="1" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm" required>
                        @error('capacity') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
                    </div>

                    <div class="col-span-2" x-data="tourImageManager()">
                        <label for="images" class="block text-sm font-medium text-gray-700">Hình ảnh Tour (Chọn nhiều ảnh)</label>
                        ...
                        <div x-show="newImages.length" x-cloak class="mt-4">
                            <p class="mb-2 text-xs font-medium text-gray-500">Ảnh đã chọn</p>
                    ...
                    <div class="p-4 mb-4 bg-gray-50 border border-gray-200 rounded-lg relative">
                        ...
                        <div class="grid grid-cols-1 gap-4 pr-8">
                            <div>
                                ...
                                <input type="text" x-model="day.title" :name="'itinerary['+index+'][title]'" :id="'itinerary_title_'+index" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm" placeholder="VD: Ngày 1 - Đón khách tại Hà Giang" required>
                            </div>
                            <div>
